 ...
 * signer_logo_lvgl.h
 *
 * KernSigner Logo rendering for LVGL-based embedded displays
 * Minimal "Essential Point" design
 */

#ifndef SIGNER_LOGO_LVGL_H
#define SIGNER_LOGO_LVGL_H
...
/**
 * Create a KernSigner logo on a canvas
 *
 ...
 */
lv_obj_t *signer_logo_create(lv_obj_t *parent, lv_coord_t x, lv_coord_t y,
                           lv_coord_t size);

/**
 * Create logo with "SIGNER" text combo
 ...
 */
lv_obj_t *signer_logo_with_text(lv_obj_t *parent, lv_coord_t x, lv_coord_t y);
 ...
 */
void signer_logo_example(void);

#ifdef __cplusplus
}
#endif

#endif /* SIGNER_LOGO_LVGL_H */
