...
专项复盘：OKX 圆点动态二维码、ZBar fallback、UR 拼包和字体乱码见 [OKX_QR_SCAN_INCIDENT_20260523.zh-CN.md](OKX_QR_SCAN_INCIDENT_20260523.zh-CN.md)。
...
如果问题发生在“开发板完全不知道这是一张二维码”，先看 [OKX_QR_SCAN_INCIDENT_20260523.zh-CN.md](OKX_QR_SCAN_INCIDENT_20260523.zh-CN.md) 的图像层排查，不要直接进入 CBOR 和签名算法。
